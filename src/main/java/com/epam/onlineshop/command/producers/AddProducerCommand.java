...
/**
 * The AddProducerCommand class responsible
 * for add new producer in database.
...
public class AddProducerCommand implements ICommand {
     ...
     * @see Logger
     */
    private static final Logger log = Logger.getLogger(AddProducerCommand.class);

    /**
     * Transfers control further down the hierarchy to the command to add new producer to the database.
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ProducersRerouting.redirectAfterAddProducer(request, response, productionRegion, brand);
