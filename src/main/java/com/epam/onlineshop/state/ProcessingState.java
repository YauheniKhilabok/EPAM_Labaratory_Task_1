...
/**
 * The ProcessingState class implements IOrderState
...
public class ProcessingState implements IOrderState {
    ...
    public void doAction(OrderContext context, int orderId) {
        ...
        StateService.changeOrderStatus(orderId, StateConstants.PROCESSING_STATE);
    }
    ...
    public String toString() {
        return StateConstants.PROCESSING_STATE;
    }
}
