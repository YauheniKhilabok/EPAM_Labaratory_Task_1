...
/**
 * The TreatedState class implements IOrderState
 ...
 * @since 2016-09-01
 */
public class TreatedState implements IOrderState {
    /**
    ...
    public void doAction(OrderContext context, int orderId) {
        ...
        StateService.changeOrderStatus(orderId, StateConstants.TREATED_STATE);
    }
    ...
    public String toString() {
        return StateConstants.TREATED_STATE;
    }
}
