...
/**
 * The AdminSecurityFilter filter is responsible for the control
 * and restriction of access to certain pages for the administrator.
 *
 * @author Evgeniy Khilabok
 * @version 1.0
 * @since 2016-09-01
 */
@WebFilter(urlPatterns = {WebConstants.ADMIN_SECURITY_PATTERN},
