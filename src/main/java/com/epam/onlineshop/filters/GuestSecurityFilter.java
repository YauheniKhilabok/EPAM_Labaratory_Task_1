...
/**
 * The GuestSecurityFilter filter is responsible for the control
 * and restriction of access to certain pages for the guest.
 *
 * @author Evgeniy Khilabok
 * @version 1.0
 * @since 2016-09-01
 */
@WebFilter(urlPatterns = {WebConstants.ADMIN_SECURITY_PATTERN, WebConstants.USER_SECURITY_PATTERN},
...
public class GuestSecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (role.equals(WebConstants.GUEST_ROLE_VALUE)) {
