...
/**
 * The SortingProductsPaginationForAdmin class responsible
 ...
 * @since 2016-09-01
 */
public class SortingProductsPaginationForAdmin extends AbstractPagination {
    /**
    ...
    public void makePagination(HttpServletRequest request) {
        ...
        if (sortingValue != null) {
            ...
            products = ProductsService.sortProductsForAdmin((page - 1) * recordsPerPage, recordsPerPage, sortingValue);
        }
        if (sortingValue == null) {
            products = ProductsService.sortProductsForAdmin((page - 1) * recordsPerPage, recordsPerPage, sortingType);
        }
